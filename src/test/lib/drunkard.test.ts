...
describe("Drunkard replacement", () => {
  ...
  it("prefers an implemented replacement that is not already in the game", () => {
    ...
    expect(getDrunkardReplacementCandidates()).toContain("v26");
    expect(pickDrunkardReplacement([], () => 0)).toBe("e04");
    expect(getDrunkardReplacementCandidates(["e04", "v01", "v02", "v03", "v04", "v05", "v26"]))
      .toEqual(["v23"]);
