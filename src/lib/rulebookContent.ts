  ...
  "a01": {
    ...
    mainDescription: {
      pt: [
        ...
        `<red>Substitui</red> a Vidente, a Menina, o Sonâmbulo, o Domador do Urso, o Domador dos Coelhos, o Domador do Corvo, o Domador da Raposa ou o Domador da Aranha (aleatório a cada jogo).`,
      ...
      fr: [
        ...
        `<red>Remplace</red> la Voyante, la Petite Fille, le Somnambule, le Maître de l’Ours, le Maître des Lapins, le Maître du Corbeau, le Maître du Renard ou le Maître de l’Araignée (aléatoire à chaque jeu).`,
