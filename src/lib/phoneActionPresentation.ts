...
export const PHONE_ACTION_PRESENTATION: Record<PhoneMode, PhoneActionPresentation> = {
  [PHONE_MODE.WEREWOLF_HUNT]: { icon: Crosshair, iconClass: "text-red-400" },
  ...
  [PHONE_MODE.COLOSSUS_RETALIATION]: { icon: Crosshair, iconClass: "text-red-400" },
  [PHONE_MODE.HUNTER_ASSASSINATION]: { icon: Crosshair, iconClass: "text-red-400" },
  [PHONE_MODE.SOLDIER_ASSASSINATION]: { icon: Crosshair, iconClass: "text-red-400" },
  [PHONE_MODE.WHITE_WEREWOLF_ASSASSINATION]: { icon: Crosshair, iconClass: "text-red-400" },
